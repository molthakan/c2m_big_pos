...
$query = $this->db->query('SELECT 
    ...
    (SELECT sum(sd.sumsale_num*sd.sumsale_price) FROM sale_list_header as sd WHERE sd.owner_id="'.$_SESSION['owner_id'].'" AND sd.adddate BETWEEN "'.$dayfrom.'" AND "'.$dayto.'") as getmoneyall,
