...
<input id="customer_name" ng-model="customer_name" class="form-control" placeholder="<?=$lang_cusname?>" style="height: 45px;width: 200px;font-size: 20px;" readonly="">
</div>
<div class="form-group">
...
<center>
<img ng-src="<?php echo $base_url;?>/{{x.product_image}}" class="img img-responsive" style="height: 100px;" title="{{x.product_name}}">
...
<div ng-if="x.product_price_discount!=0.00 && sale_type=='1'">
<strike>
{{x.product_price | number:2}}
</strike>
</div>

<div ng-if="x.product_price_discount!=0.00 && sale_type=='2'">
<strike>
...
<tr>
<td>
<?=$lang_discount?> <select ng-model="discount_percent">
...
<span ng-if="discount_last_percent!='0'" style="font-weight: normal;">{{(Sumsaleprice() + (Sumsaleprice() * vatnumber/100))*(discount_last_percent/100) | number:2 }} <?=$lang_currency?></span>
			...
			<td style="font-weight: bold;font-size: 20px;color: red;text-align: center;vertical-align:middle;">
...
<form>
		...
		<td align="right"><button type="submit" class="btn btn-success btn-lg" id="savesale" ng-click="Savesale(money_from_customer,Sumsalepricevat(),discount_last )"><?=$lang_getmoneyenter?></button>
